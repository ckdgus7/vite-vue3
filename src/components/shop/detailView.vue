            ...
            <div id="sit_ov_from">
              <div id="sit_ov_wrap">
                <div id="sit_pvi">
                  <div id="sit_pvi_big">
                    <img
                      :src="`${GET_SHOPPING.it_img}`"
                      width="300"
                      height="300"
                      :alt="`${GET_SHOPPING.it_name}`"
                      :title="`${GET_SHOPPING.it_name}`"
                    />
                  </div>
                </div>
                <section id="sit_ov" class="2017_renewal_itemform">
                  <h2 id="sit_title">
                    {{ GET_SHOPPING.it_name }}
                  ...
                  <div id="sit_ov_btn">
                    <button
                      ...
                      title="장바구니 담기"
                      class="sit_btn_cart"
                      @click.prevent="addCartItem(GET_SHOPPING)"
                    >
                      장바구니 담기
                    </button>
                    <button
                      type="button"
                      @click.prevent="shopList"
                      title="상품 리스트 보기"
                      value="상품 리스트 보기"
                      class="sit_btn_buy"
                    >
...
export default {
  ...
  setup(props, ctx) {
    ...
    const totalPrice = computed(
      () => it_num.value * parseInt(getters.GET_SHOPPING.it_price)
    );
